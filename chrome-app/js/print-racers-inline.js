...
$(document).ready(function () {
  ...
  var categoryId =
    printType == racersPrintType.byCategory
      ? lib.getURLParam("categoryId") + ""
      : null;
  ...
  var domFileStorage = new DOMFileStorageExt(function (storage) {
    ...
    domFileStorage.readEvent(fileName, function (fileContents) {
      ...
      var getCategoryName = function (cid) {
        return currentEvent.cache.PodiumCategory.id[cid].name;
      };

      var toolbarTitle = categoryId
      ...
      var grid = new appComponents.Grid({
        ...
        columns: [
          ...
          {
            label: "Category",
            dataKey: "podiumCategoryId",
            width: 250,
            getValue: function (podiumCategoryId) {
